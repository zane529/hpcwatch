...
class CollectNode(object):
    ...
    def collect_node_cpu_info(self):
        ...
        g_node_cpu_use_percent = Gauge('node_cpu_use_percent', 'The cpu use of node', ['host', 'instance_type'], registry=registry)
        g_node_cpu_use_percent.labels(host=instance_id, instance_type=instance_type).set(cpu_info.get('cpu_percent'))
        
        g_node_cpu_use_load5 = Gauge('node_cpu_loadavg_5', 'The cpu use of node', ['host', 'instance_type'], registry=registry)
        g_node_cpu_use_load5.labels(host=instance_id, instance_type=instance_type).set(cpu_info.get('loadavg_5'))
        
        g_node_cpu_use_load10 = Gauge('node_cpu_loadavg_10', 'The cpu use of node', ['host', 'instance_type'], registry=registry)
        g_node_cpu_use_load10.labels(host=instance_id, instance_type=instance_type).set(cpu_info.get('loadavg_10'))
        
        g_node_cpu_use_load15 = Gauge('node_cpu_loadavg_15', 'The cpu use of node', ['host', 'instance_type'], registry=registry)
        g_node_cpu_use_load15.labels(host=instance_id, instance_type=instance_type).set(cpu_info.get('loadavg_15'))
